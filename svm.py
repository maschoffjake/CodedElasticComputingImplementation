...
class SVM:
    ...
    def analyze(self, train_data, test_data, k_fold_splits, hyper_params, t, weights=None, debug=False):
        ...
        epoch_results = self.epochs(epochs, train_data, test_data, best['learning_rate'], best['trade_off'], t, debug=False,
                                    weights=weights)
    ...
    def k_fold(self, k_fold_splits, learning_rate, trade_off, t, weights=None):
        ...
        for i in range(5):
            ...
            epoch_results = self.epochs(epochs, k_fold_train_data, k_fold_test_data, learning_rate, trade_off, t, weights=weights)
